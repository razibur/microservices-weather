...
builder.Services.AddDbContext<TempatureDbContext>(
    opts =>
    {
...
app.MapGet("/observation/{zip}", async (string zip, [FromQuery] int? days, TempatureDbContext db) =>
{
...
app.MapPost("/Observation", async (Temperature temperature, TempatureDbContext db) =>
{
